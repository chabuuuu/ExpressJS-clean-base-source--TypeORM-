...
class AccountContainer extends BaseContainer {
  constructor() {
    ...
    this.container
      .bind<IAccountService<Account>>("AccountService")
      .to(AccountService);

    this.container
      .bind<IAccountRepository<Account>>("AccountRepository")
  ...
  export() {
    const accountController =
      this.container.get<AccountController>(AccountController);
    const accountService =
      this.container.get<IAccountService<Account>>("AccountService");
