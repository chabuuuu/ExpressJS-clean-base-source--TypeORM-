...
export class BaseContainer {
  ...
  static get(model: any) {
    ...
    container
      ...
      .to(BaseRepository<typeof model>);

    container
      .bind<IBaseCrudService<typeof model>>(ITYPES.Service)
      .to(BaseCrudService<typeof model>);

    container
      .bind<IBaseCrudController<typeof model>>("BaseCrudController")
      .to(BaseCrudController<typeof model>);

    return {
      controller:
        container.get<BaseCrudController<typeof model>>("BaseCrudController"),
